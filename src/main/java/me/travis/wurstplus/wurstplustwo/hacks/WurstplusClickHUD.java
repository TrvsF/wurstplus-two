...
public class WurstplusClickHUD extends WurstplusHack {
	...
	WurstplusSetting strings_r = create("Color R", "HUDStringsColorR", 0, 0, 255);
	WurstplusSetting strings_g = create("Color G", "HUDStringsColorG", 0, 0, 255);
	WurstplusSetting strings_b = create("Color B", "HUDStringsColorB", 200, 0, 255);
	WurstplusSetting strings_a = create("Alpha", "HUDStringsColorA", 230, 0, 255);
	WurstplusSetting compass_scale = create("Compass Scale", "HUDCompassScale", 30, 1, 60);
